 ...
 */
require(['ojs/ojcore', 'knockout', 'jquery', 'ojs/ojknockout', 'ojs/ojmodule'], // add additional JET component modules as needed
  function(oj, ko, $) // this callback gets executed when all required modules are loaded
  {
    function RootViewModel() {
      ...
      $(document).ready(function() {
        ko.applyBindings(new RootViewModel(), document.getElementsByTagName('body')[0]);
      });
  }
);
